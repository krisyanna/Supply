...
<style>
 ...
 /* Sidebar */
  ...
  .brand-icon{
    width:42px;height:42px;border-radius:12px;background:#6C5DF0;
    display:flex;align-items:center;justify-content:center;flex-shrink:0;
  }
  .brand-icon svg{width:22px;height:22px;stroke:#fff;}
  .brand-name{font-size:16px;font-weight:700;line-height:1.2;}
  .brand-sub{font-size:11px;letter-spacing:.06em;color:#6b7280;font-weight:600;}

  .nav{flex:1;display:flex;flex-direction:column;gap:2px;margin-top:4px;overflow-y:auto;}
  .nav-section-label{
    font-size:11px;font-weight:700;letter-spacing:.08em;color:#4b5563;text-transform:uppercase;
    padding:14px 12px 8px 12px;
  }
  .nav-item{
    display:flex;align-items:center;gap:12px;padding:11px 12px;border-radius:10px;
    color:#9ca3af;font-size:14.5px;font-weight:500;cursor:pointer;text-decoration:none;
  ...
  .nav-item.active{background:#6C5DF0;color:#fff;}
  .nav-item.parent-active{background:rgba(108,93,240,.12);color:#fff;}
  ...
  .sub-nav-item{
    ...
    color:#9ca3af;font-size:13.5px;font-weight:500;cursor:pointer;text-decoration:none;
  }
  .sub-nav-item svg{width:15px;height:15px;flex-shrink:0;stroke:currentColor;}
  .sub-nav-item:hover{background:rgba(255,255,255,.04);color:#fff;}
  .sub-nav-item.active{background:#6C5DF0;color:#fff;}

  .nav-footer{margin-top:12px;}
  .leave-btn{
    display:flex;align-items:center;gap:10px;justify-content:center;
    padding:11px;border-radius:10px;border:1.5px solid rgba(239,91,91,.2);
    color:#f87171;font-size:14px;font-weight:600;cursor:pointer;background:rgba(239,91,91,.04);
...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <nav class="nav">
      ...
      <a class="nav-item" href="logistics.php">
      ...
      <!-- Sub-menu only shown/expanded while inside the Logistics section.
           On the Home Dashboard it stays collapsed like the other parents. -->
    </nav>
