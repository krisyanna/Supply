...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  /* Dedicated size for the currency stat card — keeps long peso totals
     from overflowing/truncating the card while leaving the other three
     stat cards (SKUs, In Stock, Low/Out of Stock) untouched. */
  .stat-value.currency{
    font-size:22px;
    white-space:nowrap;
    overflow:hidden;
        ...
        <nav class="flex-1 px-3 py-6 space-y-1.5 overflow-y-auto">
            ...
            <div class="space-y-1">
                ...
                <div id="inventory-submenu" class="submenu-transition pl-7 pr-2 space-y-1" style="max-height:260px; opacity:1;">
                    <a href="inventory.index" class="w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold bg-gradient-to-r from-indigo-600 to-indigo-500 text-white shadow-md shadow-indigo-900/30">
                    ...
                    <a href="index.warehouse-locations" class="w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-800 transition">
                        <svg class="w-3.5 h-3.5 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
