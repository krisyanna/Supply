...
<head>
    ...
    <title>Supplier Management | ERP Suite</title>
        ...
        <span>Forecasting</span>
                ...
                <div class="space-y-1">
                    ...
                    <div id="procurement-submenu" class="submenu-transition max-h-40 opacity-100 pl-7 pr-2 space-y-1">
                        ...
                        <a href="/procurement/suppliers" class="w-full text-left flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-white bg-indigo-600/30 border border-indigo-500/30 transition">
