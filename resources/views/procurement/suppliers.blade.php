...
<head>
    ...
    <title>Supplier Management | Supply Chain ERP</title>
...
<body class="bg-[#f8f9fa] flex h-screen overflow-hidden">
    ...
    <aside class="sidebar-bg w-[260px] text-gray-400 flex flex-col h-full shrink-0 border-r border-gray-800/50">
        ...
        <nav class="flex-1 py-4 overflow-y-auto px-3 space-y-1.5">
            ...
            <div class="sidebar-active-module border border-gray-700/50 rounded-xl overflow-hidden mt-2">
                ...
                <!-- Sub-menu with Active State on Supplier Management -->
                <ul id="proc-submenu" class="pb-3 space-y-0.5 block mt-1">
                    <li>
                        <!-- INACTIVE: Reorder Recommendations -->
                    ...
                    <li>
                        ...
                        <a href="/procurement/suppliers" class="flex items-center gap-2.5 px-4 pl-10 py-2.5 text-xs font-medium bg-[#5f5cf1]/15 text-[#8b89f5] rounded-r-lg mr-4 transition-colors hover:bg-[#5f5cf1]/25 hover:text-[#a3a2f7]">
    ...
    <main class="flex-1 flex flex-col overflow-y-auto">
        ...
        <!-- KPI Cards (Updated with Icons and centered flex layout) -->
        <div class="grid grid-cols-4 gap-6 px-10 pb-8">
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Total Suppliers</p>
                    <p class="text-[32px] font-black text-gray-900 tracking-tight truncate">{{ $kpi_summary['total_suppliers'] }}</p>
                </div>
                <div class="shrink-0">
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Active Contracts</p>
                    <p class="text-[32px] font-black brand-purple-text tracking-tight truncate">{{ $kpi_summary['active_contracts'] }}</p>
                </div>
                <div class="shrink-0">
                    <svg class="w-12 h-12 text-[#5f5cf1]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                </div>
            </div>
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Pending Reviews</p>
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Avg. Performance</p>
                    <p class="text-[32px] font-black text-gray-900 tracking-tight truncate">{{ $kpi_summary['avg_performance'] }}</p>
                </div>
                <div class="shrink-0">
                    <svg class="w-12 h-12 text-gray-400/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                </div>
            </div>
        </div>
        ...
        <div class="px-10 pb-10">
            <div class="border border-gray-200/80 rounded-2xl shadow-sm bg-white overflow-hidden">
                <div class="px-7 py-5 border-b border-gray-100 bg-white">
                    <h3 class="text-[15px] font-extrabold text-gray-900">Supplier Management Ledger</h3>
                </div>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-7 py-4 text-gray-600 font-medium">{{ $supplier['contact'] }}</td>
                                <td class="px-7 py-4 text-gray-800 font-semibold">{{ $supplier['category'] }}</td>
                                <td class="px-7 py-4 text-gray-800 font-bold">{{ $supplier['performance'] }}</td>
                                <td class="px-7 py-4">
