...
<head>
    ...
    <title>PO Management | Supply Chain</title>
...
<body class="bg-[#f8f9fa] flex h-screen overflow-hidden">
        ...
        <nav class="flex-1 py-4 overflow-y-auto px-3 space-y-1.5">
            ...
            <div class="sidebar-active-module border border-gray-700/50 rounded-xl overflow-hidden mt-2">
                ...
                <ul id="proc-submenu" class="pb-3 space-y-0.5 block mt-1">
                    ...
                    <li>
                        <!-- Active Sub-menu Item for PO Management -->
                        <a href="/procurement/po-management" class="flex items-center gap-2.5 px-4 pl-10 py-2.5 text-xs font-medium bg-[#5f5cf1]/15 text-[#8b89f5] rounded-r-lg mr-4 transition-colors hover:bg-[#5f5cf1]/25 hover:text-[#a3a2f7]">
    ...
    <main class="flex-1 flex flex-col overflow-y-auto">
        ...
        <header class="flex justify-between items-center px-10 py-8">
            <div>
                <h2 class="text-[22px] font-extrabold text-gray-900 tracking-tight">Purchase Order Management</h2>
        ...
        <div class="grid grid-cols-4 gap-6 px-10 pb-8">
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Total POs</p>
                    <p class="text-[32px] font-black text-gray-900 tracking-tight truncate">{{ $kpi_summary['total_pos'] }}</p>
                </div>
                <div class="shrink-0">
                    <svg class="w-12 h-12 text-gray-400/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                </div>
            </div>
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Pending Approval</p>
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Delayed POs</p>
                    <p class="text-[32px] font-black text-red-500 tracking-tight truncate">{{ $kpi_summary['delayed_pos'] }}</p>
                </div>
                <div class="shrink-0">
            ...
            <div class="border border-gray-200/80 rounded-2xl p-6 shadow-sm bg-white flex justify-between items-center gap-3 overflow-hidden">
                <div class="flex-1 min-w-0">
                    <p class="text-[11px] font-bold text-muted-blue tracking-widest uppercase mb-1 truncate">Total PO Value</p>
                    <!-- Slightly smaller text-[26px] specifically to fit large currency amounts neatly -->
                    <p class="text-[26px] font-black text-gray-900 tracking-tight truncate">{{ $kpi_summary['total_value'] }}</p>
                </div>
                <div class="shrink-0">
        ...
        <div class="px-10 pb-10">
            <div class="border border-gray-200/80 rounded-2xl shadow-sm bg-white overflow-hidden">
                <div class="px-7 py-5 border-b border-gray-100 bg-white">
                    <h3 class="text-[15px] font-extrabold text-gray-900">Purchase Orders Ledger</h3>
                </div>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-7 py-4 text-gray-800 font-semibold">{{ $po['supplier'] }}</td>
                                <td class="px-7 py-4 text-gray-600 font-medium">{{ $po['order_date'] }}</td>
                                <td class="px-7 py-4 text-gray-600 font-medium">{{ $po['amount'] }}</td>
                                <td class="px-7 py-4">
